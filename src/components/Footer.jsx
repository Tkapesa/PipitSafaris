				...
				<Box>
					<InnerBox>
						...
						<LWraper>
							<H3>Contact Us</H3>
							<List>
								<ListItems>hello@cloudsafaris.com</ListItems>
								<ListItems>4230 Sherwoodtowne Blvd, Mississauga, ON L4Z 2G6</ListItems>
							</List>
						</LWraper>
					</InnerBox>
				</Box>
				<CopyRight>
					<P>© 2024 CloudSafari, Inc. (Ontario, Canada) All rights reserved.</P></CopyRight>
			</Wrapper>
		</>
	)
}
