    ...
    <Wrapper theme={theme}>
      <Box theme={theme}>
        <InnerBox theme={theme}>
          <Main theme={theme}>
            <Figure>
              <Image src='https://cloudsafaris.com/combo-logo-neutral-600.png' alt='Footer Logo' width={275} height={32} />
            </Figure>
            ...
            <Div>
              ...
              <Wrape theme={theme}>
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="x-twitter" class="svg-inline--fa fa-x-twitter " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <CopyRight theme={theme}>
        <P theme={theme}>© 2024 CloudSafari, Inc. (Ontario, Canada) All rights reserved.</P>
      </CopyRight>
    </Wrapper>
  );
}
