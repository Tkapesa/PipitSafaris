            ...
            <BoxWrapper>
              <IconWrapper>
                <svg
                  ...
                  class="svg-inline--fa fa-piggy-bank text-xl h-8 w-8 "
                  role="img"
              ...
              <Paper>Value</Paper>
              <P>
                By booking with local tour operators, you avoid the middle-man
                markup.
              </P>
            </BoxWrapper>
          </Div>
          <Div>
            <BoxWrapper className="inner">
              <IconWrapper style={{ background: "none", padding: "0" }}>
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
            ...
            <BoxWrapper className="inner">
              <IconWrapper style={{ background: "none", padding: "0" }}>
                <svg
                  ...
                  class="svg-inline--fa fa-user-shield text-xl h-8 w-8 "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                >
              ...
              <Paper>Safety</Paper>
              <P>
                With an on-call operator, you'll always have backup on your
                trip.
              </P>
            </BoxWrapper>
          </Div>
            ...
            <BoxWrapper>
              <IconWrapper>
                <svg
                  ...
                  class="svg-inline--fa fa-clipboard-list text-xl h-8 w-8 "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 384 512"
                >
